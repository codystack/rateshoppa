    ...
    <>
        ...
        <nav className="max-w-7xl mx-auto flex items-center justify-between py-4 md:py-7 relative z-50">
          ...
          <div className="hidden md:block">
            <a
              ...
              className="px-6 py-3 mr-3 border border-[#084040] hover:border-[#B6EA25] text-[#084040] rounded hover:bg-[#B6EA25] hover:text-[#084040] transition"
            >
              Login
            </a>
            ...
            <a
              ...
              className="bg-[#084040] text-[#B6EA25] text-lg px-6 py-3 rounded hover:bg-[#B6EA25] hover:text-[#084040] transition"
            >
              Get started
            </a>
          </div>
      ...
      >
        ...
        <ul className="flex flex-col space-y-6 px-6 pt-8 text-gray-800 text-lg font-medium flex-1 overflow-y-auto">
          <li><Link href="/about" className="block hover:text-black transition-colors">About us</Link></li>
        ...
        <div className="p-6 border-t border-gray-200">
          <a
            href="https://app.rateshoppa.com"
            className="block px-6 py-3 mb-3 border text-center border-[#084040] hover:border-[#B6EA25] text-[#084040] rounded hover:bg-[#B6EA25] hover:text-[#084040] transition"
          >
            Login
          </a>

          <a href="https://app.rateshoppa.com/signup"
            className="block bg-[#084040] text-[#B6EA25] text-center px-6 py-3 rounded hover:bg-[#B6EA25] hover:text-[#084040] transition"
          >
            Get started
          </a>
        </div>
